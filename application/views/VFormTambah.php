...
<head>
  <title>Halaman Tambah Artikel Baju</title>
  <style>
    body {
...
<body>
  ...
  <form action="<?php echo base_url('cform/fungsiTambah') ?>" method="post" enctype="multipart/form-data">
    <div class="container">
      ...
      <!-- <label<b>ID</b></label>
        ...
        <label<b>Nama</b></label>
          ...
          <label<b>Keluhan</b></label><br><br>
            <textarea id="keluhan" name="keluhan" rows="3" cols="163"></textarea> <br>
