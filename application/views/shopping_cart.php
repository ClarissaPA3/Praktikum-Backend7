...
<body>
    <div class="container">
        ...
        <div class="col-lg-6 col-md-6">
            <div class="table-responsive">
                <!-- <h3 align="center">Keranjang</h3><br /> -->
                <?php
    ...
    <div class="col-md-4" style="padding:16px; background-color:#f1f1f1; border:1px solid #ccc; margin-bottom:16px; height:400px" align="center">
     ...
     <button type="button" name="add_cart" class="btn btn-success add_cart" data-productname="' . $row->product_name . '" data-price="' . $row->product_price . '" data-productid="' . $row->product_id . '" />Masukkan keranjang</button>
    </div>
    ';
                }
                ?>
