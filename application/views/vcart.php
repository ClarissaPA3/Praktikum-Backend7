<div class="sidebar-expanded d-none d-md-block bg-light" style="margin-right: 0%; width: 22%;">
        ...
        <div id="detail_cart">
            ...
            <a href="#" style="text-decoration: none; color: black;" data-toggle="modal" data-target="#modalDetail<?php echo $item['id'] ?>">
                <div class="media">
            ...
            <hr>
            <form method="GET" action="<?php echo base_url().'ccart/editCart';?>">
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <a href="<?= base_url().'ccart/removeCart/'.$item['rowid'] ?>">
            ...
            <div style="bottom: 0%; position: fixed; width: 22%;">
                ...
                <div class="container">
                    ...
                    <br>
                    <center>
                        <a href="<?php echo base_url().'ccart/destroyCart'?>" class="btn btn-secondary">Batal</a>    
